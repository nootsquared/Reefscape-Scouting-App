...
function addTeamReminder(table, idx) {
  ...
  cell.innerHTML = '<div id="teamReminder" style="color: #00ffff;">Currently Scouting: Team <span id="currentTeam"></span></div>';
  return idx + 1;
}
...
function updateMatchStart(event) {
  ...
  updateRobotPositions(); // Add this line to update all positions
